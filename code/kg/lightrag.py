...
class LightRAG:
    ...
    def query(
        ...
        return loop.run_until_complete(self.aquery(stage,query,data_line, data_med, param, ll_keywords, system_prompt))  # type: ignore
    ...
    async def aquery(
        ...
        if param.mode in ["local", "global", "hybrid", "ll_medical"]:
            if stage==0:
                ...
                response = await kg_query_result(
                    query.strip(),
                    ll_keywords,
                    data_line,
                    data_med,
            ...
            # elif stage==2:
            #     response = await kg_query_context(
            #         query.strip(),
            #         data_line,
            #         data_med,
            #         self.chunk_entity_relation_graph,
